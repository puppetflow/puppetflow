...
use App\Policies\Mcp\McpCredentialPolicy;
use App\Policies\Media\MediaAssetPolicy;
use App\Policies\Media\MediaFolderPolicy;
...
class AuthorizationServiceProvider extends ServiceProvider
{
    public function boot(): void
    {
        ...
        Gate::policy(McpCredential::class, McpCredentialPolicy::class);
