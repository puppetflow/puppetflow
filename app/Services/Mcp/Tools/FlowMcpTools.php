...
TEXT,
            'inputSchema' => [
                ...
                'properties' => [
                    ...
                    'code' => [
                        'type' => 'string',
                        'description' => 'Complete JavaScript source defining async function run($page, $input, $context, $client); $context and $client are optional.',
                    ],
                ],
            ],
        ];
