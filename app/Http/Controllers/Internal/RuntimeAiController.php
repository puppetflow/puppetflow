...
class RuntimeAiController extends Controller
{
    ...
    public function execute(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'messages.*.content.*.type' => ['required', 'in:text,image,tool_call,tool_result'],
            ...
            'messages.*.content.*.id' => ['nullable', 'string', 'max:255'],
            'messages.*.content.*.name' => ['nullable', 'string', 'max:255'],
