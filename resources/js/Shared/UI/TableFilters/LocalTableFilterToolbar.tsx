...
export default function LocalTableFilterToolbar({
    ...
    return (
        <S.Container className={className} $compact={compact}>
            <S.Toolbar $compact={compact}>
                {compact && scopeFilter}
                <S.SearchBar $compact={compact}>
                    {!compact && <Icon icon="lucide:search" width={14} height={14} />}
                    <S.SearchInput
                        $compact={compact}
                        type="search"
