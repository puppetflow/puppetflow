...
import {
    ...
    HelpCategoryRail,
    HelpHeader,
    HelpPanel as HelpPanelContainer,
    HelpTitle,
    HelpToolbar,
...
import { HelpEntries } from '@/Domains/Snippet/Pages/SnippetEditor/components/HelpEntries/HelpEntries';
...
export function HelpPanel({
    ...
    return (
        <HelpPanelContainer data-code-help-panel>
            <HelpHeader>
                <HelpTitle>
