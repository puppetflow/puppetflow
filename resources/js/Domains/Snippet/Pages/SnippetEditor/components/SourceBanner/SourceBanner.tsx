    ...
    return (
        <S.Banner $outdated={updateAvailable}>
            <S.Text>
                ...
                {updateAvailable
                    ? 'A newer library version is available. Updating replaces code and arguments, and keeps other settings.'
                    : 'This snippet was imported from the library. Code and arguments are locked, but other settings can still be edited.'}
            </S.Text>
